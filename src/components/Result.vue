                            ...
                            <slot name="body">
                                <social-sharing inline-template
                                    ...
                                    <div class="sharing-block">
                                        <input id="ourUrl" :value="url"
                                               :style="{opacity: 0, position: 'absolute', zIndex: -1}"/>
                                        <!--<network network="link">-->
                                        <div class="tooltip tooltip-left sharing-item"
                                             :data-description="networks.copyingLinkText" @click="$emit('copy')">

                                            <svg class="share-links" width="24px" height="24px" viewBox="0 0 24 24"
                                                ...
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <path d="M3.9,12 C3.9,10.29 5.29,8.9 7,8.9 L11,8.9 L11,7 L7,7 C4.24,7 2,9.24 2,12 C2,14.76 4.24,17 7,17 L11,17 L11,15.1 L7,15.1 C5.29,15.1 3.9,13.71 3.9,12 Z M8,13 L16,13 L16,11 L8,11 L8,13 Z M17,7 L13,7 L13,8.9 L17,8.9 C18.71,8.9 20.1,10.29 20.1,12 C20.1,13.71 18.71,15.1 17,15.1 L13,15.1 L13,17 L17,17 C19.76,17 22,14.76 22,12 C22,9.24 19.76,7 17,7 Z"
                                                          class="hover-icon" fill="#98CA3E"></path>
                                                </g>
                                            </svg>
                                        </div>
                                        <!--</network>-->
                                        ...
                                        <div class="tooltip tooltip-centre sharing-item" data-description="Send email!">
                                            <network network="email">
                                                <svg class="share-links" width="24px" height="24px" viewBox="0 0 24 24"
                                                     version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                    <g id="ic-email-24px" stroke="none" stroke-width="1" fill="none"
                                                       fill-rule="evenodd">
                                        ...
                                        <network network="facebook" class="sharing-item">
                                            <svg class="share-links" width="24px" height="24px" viewBox="0 0 24 24"
                                                 version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                <g id="ic-facebook-24px" stroke="none" stroke-width="1" fill="none"
                                                   fill-rule="evenodd">
                                                    <path class="hover-icon"
                                                          d="M17.5857723,2.0043694 L14.9473725,2 C11.9832208,2 10.0676557,4.02849474 10.0676557,7.16812834 L10.0676557,9.55098155 L7.41486271,9.55098155 C7.18562989,9.55098155 7,9.74279829 7,9.97940139 L7,13.4318841 C7,13.6684873 7.18584156,13.8600855 7.41486271,13.8600855 L10.0676557,13.8600855 L10.0676557,22.5717986 C10.0676557,22.8084017 10.2532856,23 10.4825184,23 L13.9436587,23 C14.1728915,23 14.3585214,22.8081833 14.3585214,22.5717986 L14.3585214,13.8600855 L17.4602552,13.8600855 C17.689488,13.8600855 17.8751179,13.6684873 17.8751179,13.4318841 L17.8763878,9.97940139 C17.8763878,9.86579695 17.8325733,9.75699885 17.7548923,9.67660185 C17.6772114,9.59620486 17.5713791,9.55098155 17.4613135,9.55098155 L14.3585214,9.55098155 L14.3585214,7.53100715 C14.3585214,6.56012609 14.5826743,6.06725758 15.8080009,6.06725758 L17.585349,6.06660217 C17.8143701,6.06660217 18,5.87478543 18,5.6384008 L18,2.43257077 C18,2.19640461 17.8145818,2.00480634 17.5857723,2.0043694 Z"
                                                          fill="#98CA3E"></path>
                                                </g>
                                            </svg>
                                        </network>
                                        ...
                                        <network network="twitter" class="sharing-item">
                                            <svg class="share-links" width="24px" height="24px" viewBox="0 0 24 24"
                                                 version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                <g id="ic-twitter-24px" stroke="none" stroke-width="1" fill="none"
                                                   fill-rule="evenodd">
                                                    <path class="hover-icon"
                                        ...
                                        <network network="linkedin" class="sharing-item">
                                            <svg class="share-links" width="24px" height="24px" viewBox="0 0 24 24"
                                                 version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                <g id="ic-linkedin-24px" stroke="none" stroke-width="1" fill="none"
                                                   fill-rule="evenodd">
                                                    <path class="hover-icon"
                                                          d="M22,14.6488849 L22,22 L17.7133524,22 L17.7133524,15.1412183 C17.7133524,13.4182364 17.0933351,12.2423687 15.5417107,12.2423687 C14.3572423,12.2423687 13.6523644,13.0348173 13.3422627,13.8013781 C13.2291772,14.0754206 13.2000688,14.4568518 13.2000688,14.8404558 L13.2000688,22 L8.91197976,22 C8.91197976,22 8.96973149,10.383475 8.91197976,9.1799164 L13.1996503,9.1799164 L13.1996503,10.9971119 C13.190955,11.0107031 13.1796558,11.0253575 13.1714719,11.0385327 L13.1996503,11.0385327 L13.1996503,10.9971119 C13.7693093,10.1248266 14.7866604,8.87873782 17.0638082,8.87873782 C19.8850406,8.87873782 22,10.7110501 22,14.6488849 Z M4.42645606,3 C2.95950637,3 2,3.95660605 2,5.2145756 C2,6.44513165 2.93174648,7.43076919 4.36954131,7.43076919 L4.39818468,7.43076919 C5.89354524,7.43076919 6.82352476,6.44531657 6.82352476,5.2145756 C6.79534638,3.95660605 5.89354524,3 4.42645606,3 Z M2.25467489,22 L6.54113648,22 L6.54113648,9.1799164 L2.25467489,9.1799164 L2.25467489,22 Z"
                                                          id="LinkedIn" fill="#98CA3E"></path>
                                                </g>
                                            </svg>
                                        </network>
